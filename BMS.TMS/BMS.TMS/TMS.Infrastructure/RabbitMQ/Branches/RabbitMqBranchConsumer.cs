...
using TMS.Application.Branches.Commands;

namespace TMS.Infrastructure.RabbitMQ.Branches;

public class RabbitMqBranchConsumer : BackgroundService
{
    ...
    public RabbitMqBranchConsumer(IServiceScopeFactory serviceScopeFactory, IConfiguration configuration)
    {
